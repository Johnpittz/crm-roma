...
export function ModalDetalhesCliente({ cliente, open, onOpenChange }: ModalDetalhesClienteProps) {
  ...
  // wa.me: abre conversa com o número (contato salvo ou não — busca geral)
  const waUrl = urlWaMe(cliente.telefone);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        {/* Abrir conversa no WhatsApp (com ou sem contato salvo) */}
        {waUrl && (
          <a
            href={waUrl}
            target="_blank"
